...
//                database.execSQL("UPDATE playerFieldPosition set flags=1 where position=10")
    ...
    private fun migration_16_17(): Migration {
        return object : Migration(16, 17) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE tournaments ADD COLUMN startTime INTEGER NOT NULL DEFAULT 0")
                database.execSQL("ALTER TABLE tournaments ADD COLUMN endTime INTEGER NOT NULL DEFAULT 0")
