...
class GlobalNavigationTest {
    @Rule
    @JvmField
    var homeTestRule = EasyLineupActivityTestRule(
    ...
    private fun applyRotation(name: String) {
        takeScreenshot("${name}_portrait", homeTestRule.activity)

        onView(isRoot()).perform(OrientationChangeAction.orientationLandscape())

        BaristaSleepInteractions.sleep(1_000)

        takeScreenshot("${name}_landscape", homeTestRule.activity)

        onView(isRoot()).perform(OrientationChangeAction.orientationPortrait())

        BaristaSleepInteractions.sleep(2_000)
    }

    private fun initialization() {
        takeScreenshot("dashboard", homeTestRule.activity)
    ...
    fun applyPlayersManagementTests() {
        ...
        takeScreenshot("players", homeTestRule.activity)
        ...
        takeScreenshot("albert_details", homeTestRule.activity)
        ...
        takeScreenshot("albert_edit", homeTestRule.activity)
        ...
        takeScreenshot("albert_delete_dialog", homeTestRule.activity)
        ...
        takeScreenshot("add_new_player", homeTestRule.activity)
    ...
    fun applyTeamManagementTests() {
        ...
        takeScreenshot("team_details", homeTestRule.activity)
    ...
    fun applyLineupManagementTests() {
        ...
        takeScreenshot("lineups_list", homeTestRule.activity)
        ...
        takeScreenshot("lineups_list_tournament_stats", homeTestRule.activity)
        ...
        takeScreenshot("lineup_delete_popup", homeTestRule.activity)
        ...
        takeScreenshot("lineups_create_lineup", homeTestRule.activity)
    ...
    fun applySwitchTeamManagementTests() {
        ...
        takeScreenshot("swap_team_dialog", homeTestRule.activity)
