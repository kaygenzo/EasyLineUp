            ...
            tiles.forEach { tile ->
                when (tile.type) {
                    TileType.TEAM_SIZE.type -> {
                        tilesObservables.add(getTeamSize(requestValues.team).map {
                            tile.apply {
                                data = it
                            }
                        })
                    ...
                    TileType.MOST_USED_PLAYER.type -> {
                        tilesObservables.add(getMostUsedPlayer(requestValues.team).map {
                            tile.apply {
                                data = it
                            }
                        })
                    ...
                    TileType.LAST_LINEUP.type -> {
                        tilesObservables.add(getLastLineup(requestValues.team).map {
                            tile.apply {
                                data = it
                            }
                        })
                    ...
                    TileType.LAST_PLAYER_NUMBER.type -> {
                        tilesObservables.add(getLastPlayerNumberResearch().map {
                            tile.apply {
                                data = it
                            }
                        })
