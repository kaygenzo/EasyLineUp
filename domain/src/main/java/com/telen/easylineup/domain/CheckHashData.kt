...
class CheckHashData(val teamDao: TeamDao, val playerDao: PlayerDao, val tournamentDao: TournamentDao, val lineupDao: LineupDao,
                val playerFieldPositionsDao: PlayerFieldPositionsDao): UseCase<CheckHashData.RequestValues, CheckHashData.ResponseValue>() {
