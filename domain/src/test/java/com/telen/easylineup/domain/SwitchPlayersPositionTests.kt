...
internal class SwitchPlayersPositionTests {
    ...
    fun shouldTriggerSamePlayersException() {
        ...
        mSwitchPlayersPosition.executeUseCase(SwitchPlayersPosition.RequestValues(players = players,
                ...
                lineupMode = lineupMode, teamType = teamType, strategy = strategy, extraHittersSize = extraHitters)).subscribe(observer)
        observer.await()
    ...
    fun shouldSwitch_baseball_Another_Player_With_Another_Player() {
        ...
        mSwitchPlayersPosition.executeUseCase(SwitchPlayersPosition.RequestValues(players = players,
                ...
                lineupMode = lineupMode, teamType = teamType, strategy = strategy, extraHittersSize = extraHitters
        )).subscribe(observer)
        observer.await()
        observer.assertComplete()
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            assertVerification(it[0],4, 4, FieldPosition.CENTER_FIELD.id, PlayerFieldPosition.FLAG_NONE, 6)
            assertVerification(it[1],3, 3, FieldPosition.FIRST_BASE.id, PlayerFieldPosition.FLAG_NONE, 4)
        })
    }
    ...
    fun shouldSwitch_baseball_DH_and_Pitcher() {
        ...
        observer.assertComplete()
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            assertVerification(it[0],6, 6, FieldPosition.PITCHER.id, PlayerFieldPosition.FLAG_FLEX, TeamStrategy.STANDARD.getDesignatedPlayerOrder(extraHitters))
    ...
    fun shouldSwitch_baseball_DH_and_Another_Player() {
        ...
        observer.assertComplete()
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            assertVerification(it[0],6, 6, FieldPosition.FIRST_BASE.id, PlayerFieldPosition.FLAG_NONE, 8)
            assertVerification(it[1],4, 4, FieldPosition.DP_DH.id, PlayerFieldPosition.FLAG_NONE, 6)
        })
    }
    ...
    fun shouldSwitch_baseball_Pitcher_and_Another_Player() {
        ...
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            ...
            assertVerification(it[1],4, 4, FieldPosition.PITCHER.id, PlayerFieldPosition.FLAG_FLEX, TeamStrategy.STANDARD.getDesignatedPlayerOrder(extraHitters))
        })
    }
    ...
    fun shouldSwitch_baseball_Pitcher_and_Empty() {
        ...
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            ...
            assertVerification(it[0],1, 1, FieldPosition.SECOND_BASE.id, PlayerFieldPosition.FLAG_NONE, 1)
        })
    }
    ...
    fun shouldSwitch_baseball_DH_and_Empty() {
        ...
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            Assert.assertEquals(1, it.size)
            assertVerification(it[0],6, 6, FieldPosition.SECOND_BASE.id, PlayerFieldPosition.FLAG_NONE, 8)
        })
    }
    ...
    fun shouldSwitch_baseball_Another_and_Empty() {
        ...
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            Assert.assertEquals(1, it.size)
            assertVerification(it[0],4, 4, FieldPosition.SECOND_BASE.id, PlayerFieldPosition.FLAG_NONE, 6)
        })
    }
    ...
    */
    ...
    fun shouldSwitch_softball_flex_with_normal() {
        ...
        players.first { it.position == FieldPosition.PITCHER.id }.apply {
        ...
        observer.assertComplete()
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            assertVerification(it[0],2, 2, FieldPosition.CENTER_FIELD.id, PlayerFieldPosition.FLAG_FLEX, TeamStrategy.STANDARD.getDesignatedPlayerOrder(extraHitters))
    ...
    fun shouldSwitch_softball_dp_with_normal() {
        ...
        observer.assertComplete()
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            assertVerification(it[0],6, 6, FieldPosition.CENTER_FIELD.id, PlayerFieldPosition.FLAG_NONE, 8)
            assertVerification(it[1],3, 3, FieldPosition.DP_DH.id, PlayerFieldPosition.FLAG_NONE, 4)
        })
    }
    ...
    fun shouldSwitch_softball_flex_with_dp() {
        ...
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            ...
            assertVerification(it[1],6, 6, FieldPosition.CATCHER.id, PlayerFieldPosition.FLAG_FLEX, TeamStrategy.STANDARD.getDesignatedPlayerOrder(extraHitters))
        })
    }
    ...
    fun shouldSwitch_softball_dp_with_flex() {
        ...
        observer.assertComplete()
        verify(playerFieldPositionsDao).updatePlayerFieldPositions(com.nhaarman.mockitokotlin2.check {
            assertVerification(it[0],6, 6, FieldPosition.CATCHER.id, PlayerFieldPosition.FLAG_FLEX, TeamStrategy.STANDARD.getDesignatedPlayerOrder(extraHitters))
