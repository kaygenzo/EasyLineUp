...
class GetPositionsSummaryForPlayerTests {
    ...
    fun init() {
        ...
        val position6 = PositionWithLineup(position = FieldPosition.PITCHER.position)
        val position7 = PositionWithLineup(position = FieldPosition.CATCHER.position)
        val position8 = PositionWithLineup(position = FieldPosition.RIGHT_FIELD.position)
        val position9 = PositionWithLineup(position = FieldPosition.CATCHER.position)
        val position10 = PositionWithLineup(position = FieldPosition.SUBSTITUTE.position)
